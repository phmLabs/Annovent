...
<pre>$dispatcher->connect('SomeComponent.*)', array($listener, 'Method1');</pre>

This listener will be notified whenever a event is fired that starts with SomeComponent. To listen to all events you just have connect to '*'.
